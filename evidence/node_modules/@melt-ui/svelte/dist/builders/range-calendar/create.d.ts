...
export declare function createRangeCalendar<T extends DateValue = DateValue>(props?: CreateRangeCalendarProps): {
    elements: {
        calendar: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<string>, import("svelte/store").Readable<boolean>, import("svelte/store").Writable<string>, import("svelte/store").Writable<boolean>, import("svelte/store").Writable<boolean>], (node: HTMLElement) => MeltActionReturn<RangeCalendarEvents['calendar']>, ([$fullCalendarLabel, $isInvalid, $calendarId, $disabled, $readonly]: [string, boolean, string, boolean, boolean]) => {
            id: string;
            role: string;
            'aria-label': string;
        ...
        cell: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<(date: DateValue) => boolean>, import("svelte/store").Readable<(date: DateValue) => boolean>, import("svelte/store").Readable<(date: DateValue) => boolean>, import("svelte/store").Readable<{
            start: DateValue;
            end: DateValue;
        } | null>, import("svelte/store").Readable<(date: DateValue) => boolean>, import("svelte/store").Readable<(date: DateValue) => boolean>, {
        ...
        }, import("svelte/store").Readable<(date: DateValue) => boolean>], (node: HTMLElement) => MeltActionReturn<RangeCalendarEvents['cell']>, ([$isSelected, $isSelectionEnd, $isSelectionStart, $highlightedRange, $isDateDisabled, $isDateUnavailable, $placeholder, $isOutsideVisibleMonths,]: [(date: DateValue) => boolean, (date: DateValue) => boolean, (date: DateValue) => boolean, {
            start: DateValue;
            end: DateValue;
        ...
        nextButton: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<boolean>], (node: HTMLElement) => MeltActionReturn<RangeCalendarEvents['nextButton']>, ([$isNextButtonDisabled]: [boolean]) => {
            role: string;
            'aria-label': string;
            'aria-disabled': string | undefined;
        ...
        prevButton: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<boolean>], (node: HTMLElement) => MeltActionReturn<RangeCalendarEvents['prevButton']>, ([$isPrevButtonDisabled]: [boolean]) => {
            role: string;
            'aria-label': string;
            'aria-disabled': string | undefined;
            disabled: boolean | undefined;
    ...
    helpers: {
        ...
        isDateUnavailable: import("svelte/store").Readable<(date: DateValue) => boolean>;
    };
